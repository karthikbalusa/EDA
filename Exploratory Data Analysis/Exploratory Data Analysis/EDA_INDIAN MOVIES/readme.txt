...
imdb_10000---is the first dataset from kaggle
indian movies----is the second dataset from kaggle

exp----it is the third dataset from dataworld

fileout--is the unique dataset formed on merging the above 3 datasets to perform the eda
